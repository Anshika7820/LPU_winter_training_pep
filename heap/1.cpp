/*
 Heap -> a heap i a complete binary tree that follows the heap order property
      ...
      - Heap order property -> 1. Max Heap -> Every parent node is greater than or equal to its children (the largest element is always at root).
